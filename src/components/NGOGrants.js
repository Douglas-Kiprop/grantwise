...
const NGOGrants = ({ categoryName }) => {
  ...
  // --- Copy style definitions from ExploreGrants.js ---
        ...
        {!isLoading && !error && grants.length > 0 && (
          <div style={gridStyle}>
            {grants.map((grant) => {
              ...
              // --- End of Updated Amount Formatting Logic ---
